...
/** This class holds all the global functions and variables of the def.socket_io_client package. */
public final class Globals {
	 ...
	 */
    @jsweet.lang.Module("socket.io-client")
    native public static def.socket_io_client.socketioclient.Socket io(java.lang.String uri, def.socket_io_client.socketioclient.ConnectOpts opts);
    /**
	 ...
	 */
    @jsweet.lang.Module("socket.io-client")
    native public static def.socket_io_client.socketioclient.Socket io(def.socket_io_client.socketioclient.ConnectOpts opts);
    /**
	 * Looks up an existing 'Manager' for multiplexing. If the user summons:
	 * 	'io( 'http://localhost/a' );'
	 * 	'io( 'http://localhost/b' );'
	 ...
	 */
    @jsweet.lang.Module("socket.io-client")
    native public static def.socket_io_client.socketioclient.Socket socket_io_client(java.lang.String uri, def.socket_io_client.socketioclient.ConnectOpts opts);
    /**
	 * Auto-connects to the window location and defalt namespace.
	 * E.g. window.protocol + '//' + window.host + ':80/'
	 * @opts Any connect options that we want to pass along
	 ...
	 */
    @jsweet.lang.Module("socket.io-client")
    native public static def.socket_io_client.socketioclient.Socket socket_io_client(def.socket_io_client.socketioclient.ConnectOpts opts);
    /**
	 * Looks up an existing 'Manager' for multiplexing. If the user summons:
	 * 	'io( 'http://localhost/a' );'
	 * 	'io( 'http://localhost/b' );'
